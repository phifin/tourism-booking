...
export default function NavBar() {
  ...
  } else if (location.pathname === '/tour') {
    defaultRouteUI.tour = selectedUI
  } else if (location.pathname === '/flight') {
    defaultRouteUI.flight = selectedUI
  }
  return (
    <div className='flex justify-between w-3/5 mx-auto mt-14 text-white'>
      <Link to='/hotel' className={`flex ml-5 py-3 px-5 ${defaultRouteUI.defaultPage}`}>
        <span className='pr-2'>
      ...
      <Link to='/carRental' className={`flex py-3 px-5 ${defaultRouteUI.carRental}`}>
        <span className='pr-2'>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='20px' height='20px' fill='white'>
      ...
      <Link to='/tour' className={`flex py-3 px-5 ${defaultRouteUI.tour}`}>
        <span className='pr-2'>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='20px' height='20px' fill='white'>
      ...
      <Link to='/flight' className={`flex py-3 px-5 ${defaultRouteUI.flight}`}>
        <span className='pr-2'>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='20px' height='20px' fill='white'>

...
export default function PostCard({ id, userId, content, likes, comments, shares, createdAt }: Post) {
  console.log(likes)
  return (
    <div className='border shadow-xl rounded-lg'>
      <div className='mt-2 ml-4'>
        <div className='flex items-center'>
          <div className='h-12 w-12 object-cover overflow-hidden border rounded-full'>
            <img src='/src/assets/default_profile_img.jpg' alt='userProfile' className='p-1' />
          </div>
          <div className='px-2 py-1 '>
            <header className='font-bold'>Vo Nhu Phi</header>
            <div className='text-gray-500'>Yesterday at 19:12PM</div>
          </div>
        </div>
      </div>
      <div className='mt-2 ml-4'>
      ...
      <div className='flex w-95/100 mx-auto h-10 mt-4 mb-2 border-y items-center justify-around cursor-pointer'>

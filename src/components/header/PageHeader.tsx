          ...
          <div className='w-2/3 mr-10 flex justify-around items-center font-semibold pb-3 pt-5 '>
            <div className='px-5 py-4 relative'>
              <select
                ...
                defaultValue={currentLanguage} // Ngôn ngữ mặc định
                className=' border-none outline-none bg-transparent cursor-pointer px-4 py-2 focus:border-none border-gray-500 rounded-md  transition-all duration-200 appearance-none'
              >
                <option value='en' className='text-gray-500 cursor-pointer'>
                  <span>English</span>
                </option>
